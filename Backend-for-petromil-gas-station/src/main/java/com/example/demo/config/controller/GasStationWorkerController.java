...
//    public ResponseEntity<?> postGasStationWorker(@RequestBody @Valid GasStationWorker gasStationWorker) {
//
//        GlobalResponse<?> response;
//        GasStationWorkerResponse gasStationWorkerf = gasStationWorkerService.addGasStationWorker(gasStationWorker);
//
...
//    }
    ...
    public ResponseEntity<?> getWorkerByIdentification(@PathVariable Long idGasStation){
        ...
        GlobalResponse<?> response;
        List<GasStationWorkerResponse> gasStationWorkerf = gasStationWorkerService.getAllWorkersByIdGasStation(idGasStation);
...
//    public ResponseEntity<?> getWorkerByIdentification(@RequestBody @Valid GasStationWorkerRequest gasStationWorkerRequest){
//
//        GlobalResponse<?> response;
//        GasStationWorkerResponse gasStationWorkerf = gasStationWorkerService.updateGasStationWorker(gasStationWorkerRequest);
//
//        if(gasStationWorkerf == null){
//            response = new GlobalResponse<>(
//                    false,
...
//    }
    ...
    public ResponseEntity<?> editWorkerWithImage(
        ...
        GasStationWorkerResponse worker = gasStationWorkerService.updateGasStationWorkerWithImage(gasStationWorker, image);
        GlobalResponse<?> response;
